...
```bash
sudo pacman -S hyprlock hypridle hyprcursor hyprpicker waybar kitty rofi-wayland dolphin dolphin-plugins ark kio-admin dunst cliphist mpv pavucontrol xdg-user-dirs ttf-font-awesome ttf-jetbrains-mono-nerd ttf-opensans noto-fonts ttf-droid ttf-roboto
```

### Todos os pacotes

```bash
sudo pacman -S hyprland hyprlock hypridle hyprcursor hyprpicker waybar kitty rofi-wayland dolphin dolphin-plugins ark kio-admin polkit-kde-agent qt5-wayland qt6-wayland xdg-desktop-portal-hyprland xdg-desktop-portal-gtk dunst cliphist mpv pavucontrol xdg-user-dirs ttf-font-awesome ttf-jetbrains-mono-nerd ttf-opensans noto-fonts ttf-droid ttf-roboto
```
